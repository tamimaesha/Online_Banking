                ...
                <tr >
                    ...
                    <td width="1200" valign="top">
                        ...
                        <table><%
                            ...
                            String num1 = request.getParameter("account_id");
                            ...
                            %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A href='index.html'><IMG SRC='images/home1.gif'></IMG></A>
                                <%
                                    ...
                                    PreparedStatement ps = con.prepareStatement("Select * from NEWACCOUNT where account_id='" + taccountno + "'");
                                    ...
                                    PreparedStatement ps1 = con1.prepareStatement("update NEWACCOUNT set amount=? where account_id='" + taccountno + "'");
                                    ...
                                    PreparedStatement ps2 = con2.prepareStatement("Select * from NEWACCOUNT where account_id=?");
                                    ...
                                    PreparedStatement ps3 = con3.prepareStatement("update NEWACCOUNT set amount=? where account_id='" + account_id + "'");
